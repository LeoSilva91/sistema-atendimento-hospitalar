...
const Login = () => {
    ...
    try {
      ...
      if (credencial && 
        ...
        login({
          ...
          tipo: formData.tipo,
          consultorio: formData.tipo === 'medico' ? 'Consultório 1' : undefined,
  ...
  const tiposUsuario = [
    ...
    { value: 'enfermeiro', label: 'Enfermeiro', icon: '🚨', description: 'Triagem de pacientes' },
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2 text-xs text-gray-600">
              ...
              <div className="bg-gray-50 p-3 rounded">
                <strong>Enfermeiro:</strong> enfermeiro / 123456
              </div>
              <div className="bg-gray-50 p-3 rounded">
