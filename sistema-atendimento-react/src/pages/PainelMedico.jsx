                ...
                <div className="space-y-6">
                  ...
                  <Panel header="Medicamentos" className="shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <Button
                        ...
                        pt={{
                          root: { className: '!bg-white !text-green-600 !border-0 !shadow-none !font-semibold hover:!bg-green-50 hover:!text-green-700 px-4 py-2 rounded-lg transition-colors' }
                        }}
                      />
                    </div>
                          ...
                          <Card key={med.id} className="border border-gray-200 rounded-lg p-4">
                            <div className="flex justify-between items-center mb-3">
                              ...
                              <Button
                                ...
                                pt={{
                                  root: { className: '!bg-white !text-red-600 !border-0 !shadow-none !font-semibold hover:!bg-red-50 hover:!text-red-700 px-4 py-2 rounded-lg transition-colors' }
                                }}
                              />
                            </div>
                  ...
                  <div className="flex justify-end gap-4 pt-2">
                    ...
                    <Button
                      ...
                      pt={{
                        root: { className: 'bg-green-500 hover:bg-green-600 border-0 text-white px-6 py-2 rounded-lg font-semibold transition-colors' }
                      }}
                    />
                  </div>
                </div>
      ...
      <Dialog
        ...
        footer={
          <div className="flex justify-end gap-2">
            <Button label="Fechar" icon={PrimeIcons.TIMES} onClick={() => setShowPrintModal(false)} className="!bg-gray-100 !text-gray-700 !border-0 px-4 py-2 rounded-lg font-semibold hover:!bg-red-500 hover:!text-white" />
            <Button label="Imprimir" icon={PrimeIcons.PRINT} onClick={() => window.print()} className="!bg-green-600 !text-white !border-0 px-4 py-2 rounded-lg font-semibold hover:!bg-green-700" />
          </div>
        }
      >
