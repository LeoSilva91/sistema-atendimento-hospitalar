...
```bash
git clone https://github.com/LeoSilva91/sistema-atendimento-hospitalar.git
...
1. Verifique se já não foi reportado nas [Issues](https://github.com/LeoSilva91/sistema-atendimento-hospitalar/issues)
